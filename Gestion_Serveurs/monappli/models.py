...
class Type_serveurs(models.Model):
    type_srv = models.CharField(max_length=100, blank=False)
...
class Applications(models.Model):
    nom_applications = models.CharField(max_length=100, blank=False)
    logo_utilisateur = models.ImageField(upload_to='logo_utilisateur/' ,blank=True, null=True)
