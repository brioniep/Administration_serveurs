...
class Serveurs(models.Model):
    ...
    def memoire_restante(self):
        services = self.services_set.all()  # Obtenez tous les services associés à ce serveur
...
class Services(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.serveur_de_lancement.memoire_restante() < self.memoire_vive_necessaire:
            self.add_error("Pas assez de mémoire disponible sur le serveur pour ajouter ce service.")
