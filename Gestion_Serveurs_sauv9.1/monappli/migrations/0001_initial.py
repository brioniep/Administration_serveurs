    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_utilisateur', models.ImageField(blank=True, null=True, upload_to='logo_utilisateur/')),
                ('utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monappli.utilisateurs')),
            ],
        ),
    ]
